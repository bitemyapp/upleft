...
| SwiftMath | `Vendor/SwiftMath` | `upleft-math` | math pixels identical | **done**: math-image and math-tree 1285/1285 each, across 1272 committed LaTeX inputs set inline and display; parse, typeset and render together take 137–175 ms vs 263–278 ms in Swift. Only Paper Light, light appearance, is covered so far. |

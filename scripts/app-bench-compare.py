#!/usr/bin/env python3
"""Compares the app-layer benchmarks of downright-app-oracle (Swift) and
upleft-oracle (Rust) stage by stage.

  scripts/app-bench-compare.py [--rounds N] [--tolerance FRACTION]
...
The benches and their inputs:
  bench-export     corpus/generated/agent/agent-5000.md, corpus/workspace/export/fragments.md
  bench-workspace  corpus/generated
  bench-find       corpus/generated/agent/agent-5000.md
"""
...
BENCHES = [
    ("bench-export", "corpus/generated/agent/agent-5000.md"),
    ("bench-export", "corpus/workspace/export/fragments.md"),
    ("bench-workspace", "corpus/generated"),
    ("bench-find", "corpus/generated/agent/agent-5000.md"),
]

...
IMPORTER_SYMBOLS="$(nm -gU "$EXECUTABLE")"
check "$(grep -q ' _MetadataImporterPluginFactory$' <<<"$IMPORTER_SYMBOLS" && echo 1 || echo 0)" "Spotlight importer exports MetadataImporterPluginFactory"

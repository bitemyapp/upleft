...
fn sample_metadata() -> UpdateMetadata {
    UpdateMetadata {
        ...
        title: Some("Downright 1.1.0".into()),
        item_description: Some("## What's new\n- Faster parsing".into()),
        release_notes_url: None,
        info_url: Url::from_string("https://github.com/ezzy1630/Downright/releases/tag/v1.1.0"),
...
fn informational_metadata() -> UpdateMetadata {
    UpdateMetadata {
        ...
        release_notes_url: None,
        info_url: Url::from_string("https://github.com/ezzy1630/Downright/releases/tag/v1.2.0"),
        content_length: 0,
...
fn main() {
    ...
    let skipped = [
        ...
        Skipped { name: "UpdateBuildContractTests/packageAndXcodeProjectDeclareSparkleExactly", reason: "checks Downright's Package.swift and project.yml" },

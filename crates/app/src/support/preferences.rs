...
impl Preferences {
    ...
    /// domain. Works only before the first `shared()` call; otherwise hands
    /// `preferences` back. Not called by the app.
    pub fn install_shared(preferences: Preferences) -> Result<(), Preferences> {

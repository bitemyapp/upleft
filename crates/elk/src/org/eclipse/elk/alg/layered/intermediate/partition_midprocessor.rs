//! Port of `alg/layered/intermediate/PartitionMidprocessor.swift`.
//!
...
impl PartitionMidprocessor {
    pub fn new() -> PartitionMidprocessor {
        PartitionMidprocessor
    }
}

impl ILayoutProcessor for PartitionMidprocessor {

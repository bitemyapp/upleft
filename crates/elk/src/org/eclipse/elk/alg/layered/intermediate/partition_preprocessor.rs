//! Port of `alg/layered/intermediate/PartitionPreprocessor.swift`.
//!
...
impl PartitionPreprocessor {
    pub fn new() -> PartitionPreprocessor {
        PartitionPreprocessor
    }
}

impl ILayoutProcessor for PartitionPreprocessor {

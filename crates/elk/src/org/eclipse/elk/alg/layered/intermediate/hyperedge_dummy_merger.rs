//! Port of `alg/layered/intermediate/HyperedgeDummyMerger.swift`.
//!
...
impl HyperedgeDummyMerger {
    pub fn new() -> HyperedgeDummyMerger {
        HyperedgeDummyMerger
    }
}

impl ILayoutProcessor for HyperedgeDummyMerger {

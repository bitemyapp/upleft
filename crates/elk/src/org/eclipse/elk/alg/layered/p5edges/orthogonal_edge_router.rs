//! Port of `vendor/elk-swift/Sources/ElkSwift/ELK/org/eclipse/elk/alg/layered/p5edges/org_eclipse_elk_alg_layered_p5edges_OrthogonalEdgeRouter.swift`.
//!
//! Not ported yet.
...
impl ILayoutProcessor for OrthogonalEdgeRouter {
    fn process(&mut self, _lg: &mut LGraphArena, _graph: LGraphId, _monitor: &mut dyn IElkProgressMonitor) {
        unimplemented!("OrthogonalEdgeRouter is not ported yet")
    }

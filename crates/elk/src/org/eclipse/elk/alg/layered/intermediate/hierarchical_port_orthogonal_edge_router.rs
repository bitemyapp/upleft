//! Port of `vendor/elk-swift/Sources/ElkSwift/ELK/org/eclipse/elk/alg/layered/intermediate/org_eclipse_elk_alg_layered_intermediate_HierarchicalPortOrthogonalEdgeRouter.swift`.
//!
//! Not ported yet.
...
impl ILayoutProcessor for HierarchicalPortOrthogonalEdgeRouter {
    fn process(&mut self, _lg: &mut LGraphArena, _graph: LGraphId, _monitor: &mut dyn IElkProgressMonitor) {
        unimplemented!("HierarchicalPortOrthogonalEdgeRouter is not ported yet")
    }

//! Port of `alg/layered/intermediate/InteractiveExternalPortPositioner.swift`.
//!
...
impl InteractiveExternalPortPositioner {
    pub fn new() -> InteractiveExternalPortPositioner {
        InteractiveExternalPortPositioner
    }
}

impl ILayoutProcessor for InteractiveExternalPortPositioner {

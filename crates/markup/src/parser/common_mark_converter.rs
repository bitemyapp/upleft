//! Port of `Sources/Markdown/Parser/CommonMarkConverter.swift`: runs
//! cmark-gfm with the extensions swift-markdown attaches and converts its
//! node tree into markup, event by event, exactly as `MarkupParser` does.

...
use super::language_spec::{
    BlockCommentSpec, LanguageSpec, RawStringStyle, StringPrefixSpec, StringSpec,
};
...
fn ecma_spec(name: &str, extra_keywords: &[&str], extra_types: &[&str]) -> LanguageSpec {
    let keywords: Vec<&str> = ECMA_KEYWORDS
        .iter()
    ...
    let types: Vec<&str> = extra_types
        ...
        .copied()
        .chain([
            "Array", "Object", "Promise", "Map", "Set", "Date", "RegExp", "Error",
        ])
        .collect();
    LanguageSpec {
        words: WordTable::new(
...
fn c() -> LanguageSpec {
    LanguageSpec {
        words: WordTable::new(
            false,
            &[
                (T::Constant, &["NULL", "true", "false"]),
                (T::Keyword, C_KEYWORDS),
                (T::Type, C_TYPES),
            ],
        ),
        all_caps_are_constants: true,
        ...
        words: WordTable::new(
            ...
            &[
                (
                    T::Constant,
                    &[
                        "NULL", "nil", "Nil", "YES", "NO", "true", "false", "self", "super",
                    ],
                ),
                (T::Keyword, &keywords),
                (T::Type, &types),
            ...
            &[
                ...
                (
                    ...
                    &[
                        ...
                        "exec", "exit", "export", "getopts", "kill", "let", "local", "popd",
                        "printf", "pushd", "read", "readonly", "return", "set", "shift", "source",
                        "test", "trap", "type", "typeset", "ulimit", "umask", "unalias", "unset",
                        "wait",
                    ],
                ),
            ],

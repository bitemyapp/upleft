//! A test runner for suites whose code under test delivers to the main queue
//! (`PreviewViewController`). The same runner as `upleft-app`'s
//! `tests/main_thread/mod.rs`.
//!
